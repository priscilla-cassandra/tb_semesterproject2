...
export function renderCreditsMobile(credits) {
  return `
        <section aria-labelledby="credits" class=" text-md rounded-lg text-center flex items-center justify-center gap-2 bg-linear-to-r from-primary-blue via-gradient-blue-middle to-gradient-blue py-2 px-4">
